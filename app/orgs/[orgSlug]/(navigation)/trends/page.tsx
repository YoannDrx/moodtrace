    ...
    <Layout size="lg">
      ...
      <LayoutContent className="flex flex-col gap-6 lg:gap-8">
        <Typography variant="muted">
          Analysez l'evolution de votre humeur et identifiez les patterns.
        </Typography>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Dernieres entrees</CardTitle>
          </CardHeader>
          <CardContent>
            {entries.length === 0 ? (
              <p className="text-muted-foreground">
                Aucune entree. Commencez a enregistrer votre humeur.
              </p>
            ) : (
                ...
                {entries.slice(0, 7).map((entry) => (
                  ...
                  >
                    ...
                    <div className="text-muted-foreground flex gap-4 text-sm">
                      {entry.energy && <span>Energie: {entry.energy}</span>}
                      {entry.sleepHours && (
